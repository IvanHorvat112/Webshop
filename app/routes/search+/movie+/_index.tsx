...
export const meta = mergeMeta(() => [
  { title: 'YouFlix - Search Movies' },
  { name: 'description', content: 'Search Movies on YouFlix' },
  {
    property: 'og:url',
    content: 'https://youflix.xyz/search/movie/ ',
  },
  { property: 'og:title', content: 'YouFlix - Search Movies' },
  { property: 'og:description', content: 'Search Movies on YouFlix' },
  { name: 'twitter:title', content: 'YouFlix - Search Movies' },
  { name: 'twitter:description', content: 'Search Movies on YouFlix' },
]);
