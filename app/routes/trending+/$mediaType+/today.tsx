...
export const meta = mergeMeta(({ params }) => {
  ...
  return [
    { title: `YouFlix - Trending ${mediaType} today` },
    {
      name: 'keywords',
      content: `trending, trending ${mediaType}, trending today, trending ${mediaType} today`,
    },
    { property: 'og:url', content: `https://youflix.xyz/trending/${mediaType}/today` },
    { property: 'og:title', content: `YouFlix - Trending ${mediaType} today` },
    { name: 'description', content: `Trending ${mediaType} today` },
    { property: 'og:description', content: `Trending ${mediaType} today` },
    { name: 'twitter:title', content: `YouFlix - Trending ${mediaType} today` },
