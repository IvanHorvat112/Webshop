...
export const meta = mergeMeta<null, { 'routes/people+/$peopleId': typeof peopleIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      { title: `YouFlix - ${peopleTitle}` },
      {
        property: 'og:url',
        content: `https://youflix.xyz/people/${params.peopleId}/`,
      },
      { property: 'og:title', content: `YouFlix - ${peopleTitle}` },
      { name: 'twitter:title', content: `YouFlix - ${peopleTitle}` },
    ];
  },
);
