...
export const meta = mergeMeta(() => [
  { title: 'YouFlix - Discover anime' },
  { name: 'description', content: 'Discover Anime on YouFlix' },
  { property: 'og:url', content: 'https://youflix.xyz/discover/anime' },
  { property: 'og:title', content: 'YouFlix - Discover anime' },
  { property: 'og:image', content: 'https://youflix.xyz/api/ogimage?it=anime' },
  { property: 'og:description', content: 'Discover Anime on YouFlix' },
  { name: 'twitter:title', content: 'YouFlix - Discover anime' },
  { name: 'twitter:description', content: 'Discover Anime on YouFlix' },
  { name: 'twitter:image', content: 'https://youflix.xyz/api/ogimage?it=anime' },
]);
