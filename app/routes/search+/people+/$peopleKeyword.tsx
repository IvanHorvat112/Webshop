...
export const meta = mergeMeta(({ data, params }) => {
  ...
  return [
    { title: `YouFlix - Search results for ${params.peopleKeyword}` },
    {
      name: 'keywords',
    ...
    {
      property: 'og:url',
      content: `https://youflix.xyz/search/people/${params.peopleKeyword}`,
    },
    { property: 'og:title', content: `YouFlix - Search results for ${params.peopleKeyword}` },
    {
      property: 'og:image',
    ...
    { name: 'twitter:title', content: `YouFlix - Search results for ${params.peopleKeyword}` },
  ];
});
