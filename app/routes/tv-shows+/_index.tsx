...
export const meta = mergeMeta(() => [
  { title: 'YouFlix - Tv Shows' },
  { name: 'description', content: 'Discover tv shows in YouFlix' },
  { property: 'og:url', content: 'https://youflix.xyz/tv-shows/' },
  { property: 'og:title', content: 'YouFlix - Tv Shows' },
  { property: 'og:description', content: 'Discover tv shows in YouFlix' },
  { name: 'twitter:title', content: 'YouFlix - Tv Shows' },
  { name: 'twitter:description', content: 'Discover tv shows in YouFlix' },
]);
