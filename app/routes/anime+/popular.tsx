...
export const meta = mergeMeta(() => [
  { title: 'YouFlix - Popular Anime' },
  { name: 'description', content: 'Popular Anime' },
  { property: 'og:url', content: 'https://youflix.xyz/anime/popular' },
  { property: 'og:title', content: 'YouFlix - Popular Anime' },
  { property: 'og:description', content: 'Popular Anime' },
  { name: 'twitter:title', content: 'YouFlix - Popular Anime' },
