...
export const meta = mergeMeta(() => [
  { title: 'YouFlix - Sign In' },
  { name: 'description', content: 'Sign in to your YouFlix account.' },
  { property: 'og:title', content: 'YouFlix - Sign In' },
  { property: 'og:description', content: 'Sign in to your YouFlix account.' },
  { property: 'og:url', content: 'https://youflix.xyz/sign-in' },
  { property: 'twitter:title', content: 'YouFlix - Sign In' },
  { property: 'twitter:description', content: 'Sign in to your YouFlix account.' },
]);
