...
export const meta = mergeMeta(() => [
  { title: 'YouFlix - Movies' },
  { name: 'description', content: 'Discover movies in YouFlix' },
  { property: 'og:url', content: 'https://youflix.xyz/movies/' },
  { property: 'og:title', content: 'YouFlix - Movies' },
  { property: 'og:description', content: 'Discover movies in YouFlix' },
  { name: 'twitter:title', content: 'YouFlix - Movies' },
  { name: 'twitter:description', content: 'Discover movies in YouFlix' },
]);
