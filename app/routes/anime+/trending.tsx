...
export const meta = mergeMeta(() => [
  { title: 'YouFlix - Trending Anime' },
  { name: 'description', content: 'Trending Anime' },
  { property: 'og:url', content: 'https://youflix.xyz/anime/trending' },
  { property: 'og:title', content: 'YouFlix - Trending Anime' },
  { property: 'og:description', content: 'Trending Anime' },
  { name: 'twitter:title', content: 'YouFlix - Trending Anime' },
