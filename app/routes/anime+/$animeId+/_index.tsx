...
export const meta = mergeMeta<{}, { 'routes/anime+/$animeId': typeof animeIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      ...
      { property: 'og:url', content: `https://youflix.xyz/anime/${params.animeId}` },
      { property: 'og:title', content: `YouFlix - ${animeTitle}` },
      {
      ...
      { name: 'twitter:title', content: `YouFlix - ${animeTitle}` },
      {
