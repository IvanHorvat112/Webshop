...
export const meta = mergeMeta(() => [
  { title: 'YouFlix - Search Anime' },
  { name: 'description', content: 'Search Anime on YouFlix' },
  { property: 'og:url', content: 'https://youflix.xyz/search/anime/' },
  { property: 'og:title', content: 'YouFlix - Search Anime' },
  { property: 'og:description', content: 'Search Anime on YouFlix' },
  { name: 'twitter:title', content: 'YouFlix - Search Anime' },
  { name: 'twitter:description', content: 'Search Anime on YouFlix' },
]);
