...
export const meta = mergeMeta(() => [
  { title: 'YouFlix - Now Playing Movies' },
  { name: 'description', content: 'Now Playing Movies' },
  { property: 'og:url', content: 'https://youflix.xyz/movies/now-playing' },
  { property: 'og:title', content: 'YouFlix - Now Playing Movies' },
  { property: 'og:description', content: 'Now Playing Movies' },
  { name: 'twitter:title', content: 'YouFlix - Now Playing Movies' },
