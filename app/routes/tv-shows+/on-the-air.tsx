...
export const meta = mergeMeta(() => [
  { title: 'YouFlix - On air Tv Shows' },
  { name: 'description', content: 'On air Tv Shows' },
  { property: 'og:url', content: 'https://youflix.xyz/tv-shows/on-the-air' },
  { property: 'og:title', content: 'YouFlix - On air Tv Shows' },
  { property: 'og:description', content: 'On air Tv Shows' },
  { name: 'twitter:title', content: 'YouFlix - On air Tv Shows' },
