...
export const meta = mergeMeta(() => [
  { title: 'YouFlix - Top Rated Tv Shows' },
  { name: 'description', content: 'Top Rated Tv Shows' },
  { property: 'og:url', content: 'https://youflix.xyz/tv-shows/top-rated' },
  { property: 'og:title', content: 'YouFlix - Top Rated Tv Shows' },
  { property: 'og:description', content: 'Top Rated Tv Shows' },
  { name: 'twitter:title', content: 'YouFlix - Top Rated Tv Shows' },
