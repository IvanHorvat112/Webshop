...
export const meta = mergeMeta<typeof loader, { 'routes/movies+/$movieId': typeof movieIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      { title: `YouFlix - ${movieTitle} - Similar` },
      {
        property: 'og:url',
        content: `https://youflix.xyz/movies/${params.movieId}/similar`,
      },
      { property: 'og:title', content: `YouFlix - ${movieTitle} - Similar` },
      { name: 'twitter:title', content: `YouFlix - ${movieTitle} - Similar` },
    ];
  },
);
