...
export const meta = mergeMeta(() => [
  { title: 'YouFlix - Discover movies' },
  { name: 'description', content: 'Discover Movies on YouFlix' },
  { property: 'og:url', content: 'https://youflix.xyz/discover/movies' },
  { property: 'og:title', content: 'YouFlix - Discover movies' },
  { property: 'og:image', content: 'https://youflix.xyz/api/ogimage?it=movies' },
  { property: 'og:description', content: 'Discover Movies on YouFlix' },
  { name: 'twitter:title', content: 'YouFlix - Discover movies' },
  { name: 'twitter:description', content: 'Discover Movies on YouFlix' },
  { name: 'twitter:image', content: 'https://youflix.xyz/api/ogimage?it=movies' },
]);
