...
export const meta = mergeMeta(() => [
  { title: 'YouFlix - Popular Tv Shows' },
  { name: 'description', content: 'Popular Tv Shows' },
  { property: 'og:url', content: 'https://youflix.xyz/tv-shows/popular' },
  { property: 'og:title', content: 'YouFlix - Popular Tv Shows' },
  { property: 'og:description', content: 'Popular Tv Shows' },
  { name: 'twitter:title', content: 'YouFlix - Popular Tv Shows' },
