...
export const meta = mergeMeta(() => [
  { title: 'YouFlix - Upcoming Movies' },
  { name: 'description', content: 'Upcoming Movies' },
  { property: 'og:url', content: 'https://youflix.xyz/movies/upcoming' },
  { property: 'og:title', content: 'YouFlix - Upcoming Movies' },
  { property: 'og:description', content: 'Upcoming Movies' },
  { name: 'twitter:title', content: 'YouFlix - Upcoming Movies' },
