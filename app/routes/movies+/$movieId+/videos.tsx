...
export const meta = mergeMeta<typeof loader, { 'routes/movies+/$movieId': typeof movieIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      { title: `YouFlix - ${movieTitle} - Videos` },
      {
        property: 'og:url',
        content: `https://youflix.xyz/movies/${params.movieId}/videos`,
      },
      { property: 'og:title', content: `YouFlix - ${movieTitle} - Videos` },
      { name: 'twitter:title', content: `YouFlix - ${movieTitle} - Videos` },
    ];
  },
);
