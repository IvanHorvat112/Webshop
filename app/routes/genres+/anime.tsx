...
export const meta = mergeMeta(() => [
  { title: 'YouFlix Anime - Genres' },
  { name: 'description', content: 'Anime Genres' },
  { property: 'og:url', content: 'https://youflix.xyz/genres/anime' },
  { property: 'og:title', content: 'YouFlix Anime - Genres' },
  { property: 'og:image', content: 'https://youflix.xyz/api/ogimage?it=anime' },
  { property: 'og:description', content: 'Anime Genres' },
  { name: 'twitter:title', content: 'YouFlix Anime - Genres' },
