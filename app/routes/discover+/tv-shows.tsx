...
export const meta = mergeMeta(() => [
  { title: 'YouFlix - Discover tv shows' },
  { name: 'description', content: 'Discover tv shows on YouFlix' },
  { property: 'og:url', content: 'https://youflix.xyz/discover/tv-shows' },
  { property: 'og:title', content: 'YouFlix - Discover tv shows' },
  { property: 'og:image', content: 'https://youflix.xyz/api/ogimage?it=tvshows' },
  { property: 'og:description', content: 'Discover tv shows on YouFlix' },
  { name: 'twitter:title', content: 'YouFlix - Discover tv shows' },
  { name: 'twitter:description', content: 'Discover tv shows on YouFlix' },
  { name: 'twitter:image', content: 'https://youflix.xyz/api/ogimage?it=tvshows' },
]);
