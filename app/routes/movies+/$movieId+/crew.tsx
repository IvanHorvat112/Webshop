...
export const meta = mergeMeta<typeof loader, { 'routes/movies+/$movieId': typeof movieIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      { title: `YouFlix - ${movieTitle} - Crew` },
      {
        property: 'og:url',
        content: `https://youflix.xyz/movies/${params.movieId}/crew`,
      },
      { property: 'og:title', content: `YouFlix - ${movieTitle} - Crew` },
      { name: 'twitter:title', content: `YouFlix - ${movieTitle} - Crew` },
    ];
  },
);
