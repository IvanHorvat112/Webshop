...
export const meta = mergeMeta(() => [
  { title: 'YouFlix - Featured Lists' },
  { property: 'og:url', content: 'https://youflix.xyz/lists/' },
  { property: 'og:title', content: 'YouFlix - Featured Lists' },
  { name: 'twitter:title', content: 'YouFlix - Featured Lists' },
]);
