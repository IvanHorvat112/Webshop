...
export const meta = mergeMeta(() => [
  { title: 'YouFlix - Search People' },
  { name: 'description', content: 'Search People on YouFlix' },
  { property: 'og:url', content: 'https://youflix.xyz/search/people/' },
  { property: 'og:title', content: 'YouFlix - Search People' },
  { property: 'og:description', content: 'Search People on YouFlix' },
  { name: 'twitter:title', content: 'YouFlix - Search People' },
  { name: 'twitter:description', content: 'Search People on YouFlix' },
]);
