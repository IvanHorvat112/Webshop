...
export const meta = mergeMeta(() => [
  { title: 'YouFlix Tv shows - Genres' },
  { name: 'description', content: 'Tv shows Genres' },
  { property: 'og:url', content: 'https://youflix.xyz/genres/tv' },
  { property: 'og:title', content: 'YouFlix Tv shows - Genres' },
  { property: 'og:image', content: 'https://youflix.xyz/api/ogimage?it=tvshows' },
  { property: 'og:description', content: 'Tv shows Genres' },
  { name: 'twitter:title', content: 'YouFlix Tv shows - Genres' },
