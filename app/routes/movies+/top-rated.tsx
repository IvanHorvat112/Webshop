...
export const meta = mergeMeta(() => [
  { title: 'YouFlix - Top Rated Movies' },
  { name: 'description', content: 'Top Rated Movies' },
  { property: 'og:url', content: 'https://youflix.xyz/movies/top-rated' },
  { property: 'og:title', content: 'YouFlix - Top Rated Movies' },
  { property: 'og:description', content: 'Top Rated Movies' },
  { name: 'twitter:title', content: 'YouFlix - Top Rated Movies' },
