...
export const meta = mergeMeta(({ data, params }) => {
  ...
  return [
    { title: `YouFlix - Search results for ${params.movieKeyword}` },
    {
      name: 'keywords',
    ...
    {
      property: 'og:url',
      content: `https://youflix.xyz/search/movie/${params.movieKeyword}`,
    },
    { property: 'og:title', content: `YouFlix - Search results for ${params.movieKeyword}` },
    {
      property: 'og:image',
    ...
    { name: 'twitter:title', content: `YouFlix - Search results for ${params.movieKeyword}` },
  ];
});
