...
export const meta = mergeMeta<null, { 'routes/people+/$peopleId': typeof peopleIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      { title: `YouFlix - ${peopleTitle} - Media` },
      {
        property: 'og:url',
        content: `https://youflix.xyz/people/${params.peopleId}/media`,
      },
      { property: 'og:title', content: `YouFlix - ${peopleTitle} - Media` },
      { name: 'twitter:title', content: `YouFlix - ${peopleTitle} - Media` },
    ];
  },
);
