...
export const meta = mergeMeta(() => [
  { title: 'YouFlix - Search Tv Shows' },
  { name: 'description', content: 'Search Tv Shows on YouFlix' },
  { property: 'og:url', content: 'https://youflix.xyz/search/tv/' },
  { property: 'og:title', content: 'YouFlix - Search Tv Shows' },
  { property: 'og:description', content: 'Search Tv Shows on YouFlix' },
  { name: 'twitter:title', content: 'YouFlix - Search Tv Shows' },
  { name: 'twitter:description', content: 'Search Tv Shows on YouFlix' },
]);
