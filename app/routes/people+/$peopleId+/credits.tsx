...
export const meta = mergeMeta<null, { 'routes/people+/$peopleId': typeof peopleIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      { title: `YouFlix - ${peopleTitle} - Credits` },
      {
        property: 'og:url',
        content: `https://youflix.xyz/people/${params.peopleId}/credits`,
      },
      { property: 'og:title', content: `YouFlix - ${peopleTitle} - Credits` },
      { name: 'twitter:title', content: `YouFlix - ${peopleTitle} - Credits` },
    ];
  },
);
