...
export const meta = mergeMeta(() => [
  { title: 'YouFlix - Recent Anime Episodes' },
  { name: 'description', content: 'Recent Anime Episodes' },
  { property: 'og:url', content: 'https://youflix.xyz/anime/recent-episodes' },
  { property: 'og:title', content: 'YouFlix - Recent Anime Episodes' },
  { property: 'og:description', content: 'Recent Anime Episodes' },
  { name: 'twitter:title', content: 'YouFlix - Recent Anime Episodes' },
