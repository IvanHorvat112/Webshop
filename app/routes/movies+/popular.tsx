...
export const meta = mergeMeta(() => [
  { title: 'YouFlix - Popular Movies' },
  { name: 'description', content: 'Popular Movies' },
  { property: 'og:url', content: 'https://youflix.xyz/movies/popular' },
  { property: 'og:title', content: 'YouFlix - Popular Movies' },
  { property: 'og:description', content: 'Popular Movies' },
  { name: 'twitter:title', content: 'YouFlix - Popular Movies' },
