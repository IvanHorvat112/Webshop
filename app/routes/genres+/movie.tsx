...
export const meta = mergeMeta(() => [
  { title: 'YouFlix Movies - Genres' },
  { name: 'description', content: 'Movies Genres' },
  { property: 'og:url', content: 'https://youflix.xyz/genres/movies' },
  { property: 'og:title', content: 'YouFlix Movies - Genres' },
  { property: 'og:image', content: 'https://youflix.xyz/api/ogimage?it=movies' },
  { property: 'og:description', content: 'Movies Genres' },
  { name: 'twitter:title', content: 'YouFlix Movies - Genres' },
