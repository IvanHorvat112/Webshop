...
export const meta = mergeMeta(({ params }) => {
  ...
  return [
    { title: `YouFlix - Trending ${mediaType} This Week` },
    {
      name: 'keywords',
      content: `trending, trending ${mediaType}, trending this week, trending ${mediaType} this week`,
    },
    { property: 'og:url', content: `https://youflix.xyz/trending/${mediaType}/week` },
    { property: 'og:title', content: `YouFlix - Trending ${mediaType} This Week` },
    { name: 'description', content: `Trending ${mediaType} This Week` },
    { property: 'og:description', content: `Trending ${mediaType} This Week` },
    { name: 'twitter:title', content: `YouFlix - Trending ${mediaType} This Week` },
