...
export const meta = mergeMeta<typeof loader, { 'routes/movies+/$movieId': typeof movieIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      { title: `YouFlix - ${movieTitle} - Photos` },
      {
        property: 'og:url',
        content: `https://youflix.xyz/movies/${params.movieId}/photos`,
      },
      { property: 'og:title', content: `YouFlix - ${movieTitle} - Photos` },
      { name: 'twitter:title', content: `YouFlix - ${movieTitle} - Photos` },
    ];
  },
);
