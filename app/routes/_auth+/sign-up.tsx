...
export const meta = mergeMeta(() => [
  { title: 'YouFlix - Sign Up' },
  { name: 'description', content: 'Sign up for a YouFlix account.' },
  { property: 'og:title', content: 'YouFlix - Sign Up' },
  { property: 'og:description', content: 'Sign up for a YouFlix account.' },
  { property: 'og:url', content: 'https://youflix.xyz/sign-up' },
  { property: 'twitter:title', content: 'YouFLix - Sign Up' },
  { property: 'twitter:description', content: 'Sign up for a YouFLix account.' },
]);
