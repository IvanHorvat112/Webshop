...
export const meta = mergeMeta<typeof loader>(({ data, params }) => {
  ...
  const { detail } = data;
  return [
    { title: `YouFlix - ${detail?.name || ''}` },
    { name: 'description', content: `${detail?.description || ''}` },
    { name: 'keywords', content: `${detail?.name || ''}` },
    {
      property: 'og:url',
      content: `https://youflix.xyz/lists/${params.listId}`,
    },
    { property: 'og:title', content: `YouFlix - ${detail?.name || ''}` },
    { property: 'og:description', content: `${detail?.description || ''}` },
    { name: 'twitter:title', content: `YouFlix - ${detail?.name || ''}` },
