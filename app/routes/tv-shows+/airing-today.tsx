...
export const meta = mergeMeta(() => [
  { title: 'YouFlix - Airing Today Tv Shows' },
  { name: 'description', content: 'Airing Today Tv Shows' },
  { property: 'og:url', content: 'https://youflix.xyz/tv-shows/airing-today' },
  { property: 'og:title', content: 'YouFlix - Airing Today Tv Shows' },
  { property: 'og:description', content: 'Airing Today Tv Shows' },
  { name: 'twitter:title', content: 'YouFlix - Airing Today Tv Shows' },
