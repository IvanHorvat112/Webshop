...
export const meta: V2_MetaFunction<typeof loader> = () => [
  { title: 'YouFlix' },
  { name: 'description', content: 'Watching movies, series, anime and more in YouFlix' },
  {
    name: 'keywords',
    content:
      'YouFlix, YouFlix Movies, YouFlix Series, YouFlix Anime, YouFlix Chill, watch movies, watch series, watch anime, watch movies online, watch series online, watch anime online, free movies, free series, free anime, free movies online, free series online, free anime online, watch movies free, watch series free, watch anime free, watch movies online free, watch series online free, watch anime online free',
  },
  { property: 'og:url', content: 'https://youflix.xyz' },
  { property: 'og:title', content: 'YouFlix' },
  { property: 'og:image', content: 'https://youflix.xyz/api/ogimage?it=home' },
  { property: 'og:description', content: 'Watching movies, series, anime and more on YouFlix' },
  { property: 'og:type', content: 'website' },
  { property: 'og:site_name', content: 'YouFlix' },
  { property: 'og:image:width', content: '1200' },
  { property: 'og:image:height', content: '630' },
  { name: 'twitter:card', content: 'summary_large_image' },
  { name: 'twitter:site', content: '@YouFlix' },
  { name: 'twitter:image', content: 'https://youflix.xyz/api/ogimage?it=home' },
  { name: 'twitter:title', content: 'YouFlix' },
  { name: 'twitter:description', content: 'Watching movies, series, anime and more on YouFlix' },
];
  ...
  React.useEffect(() => {
    if (isUpdateAvailable) {
      toast.success('Update Available', {
        description: 'A new version of YouFlix is available.',
        action: {
          label: 'Update',
          onClick: () => reloadPage(),
        },
