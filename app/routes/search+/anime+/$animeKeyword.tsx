...
export const meta = mergeMeta(({ data, params }) => {
  ...
  return [
    { title: `YouFlix - Search results for ${params.animeKeyword}` },
    {
      name: 'keywords',
    ...
    {
      property: 'og:url',
      content: `https://youflix.xyz/search/anime/${params.animeKeyword}`,
    },
    { property: 'og:title', content: `YouFlix - Search results for ${params.animeKeyword}` },
    {
      property: 'og:image',
    ...
    { name: 'twitter:title', content: `YouFlix - Search results for ${params.animeKeyword}` },
  ];
});
