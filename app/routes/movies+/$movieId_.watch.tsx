...
export const meta = mergeMeta<typeof loader>(({ data, params }) => {
  ...
  return [
    { title: `YouFlix - Watch ${movieTitle}` },
    ...
    { property: 'og:url', content: `https://youflix.xyz/movies/${params.movieId}/watch` },
    { property: 'og:title', content: `YouFlix - Watch ${movieTitle}` },
    { property: 'og:description', content: overview },
    {
      property: 'og:image',
      content: `https://youflix.xyz/api/ogimage?m=${params.movieId}&mt=movie`,
    },
    { name: 'twitter:title', content: `YouFlix - Watch ${movieTitle}` },
