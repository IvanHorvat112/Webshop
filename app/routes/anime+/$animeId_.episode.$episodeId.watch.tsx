...
export const meta = mergeMeta<typeof loader>(({ data, params }) => {
  ...
  return [
    { title: `YouFlix - Watch ${animeTitle} episode ${episodeInfo?.number || ''}` },
    {
      name: 'description',
      content: description
    ...
    {
      property: 'og:url',
      content: `https://youflix.xyz/anime/${params.animeId}/episode/${params.episodeId}/watch`,
    },
    {
      property: 'og:title',
      content: `YouFlix - Watch ${animeTitle} episode ${episodeInfo?.number || ''}`,
    },
    {
