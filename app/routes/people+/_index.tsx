...
export const meta = mergeMeta(() => [
  { title: 'YouFlix - Popular People' },
  { name: 'description', content: 'Discover the most popular celebrities on YouFlix.' },
  {
    name: 'keywords',
    content:
  ...
  { property: 'og:url', content: 'https://youflix.xyz/people' },
  { property: 'og:title', content: 'YouFlix - Popular People' },
  { property: 'og:image', content: 'https://youflix.xyz/api/ogimage?it=people' },
  { property: 'og:description', content: 'Discover the most popular celebrities on YouFlix.' },
  { name: 'twitter:title', content: 'YouFlix - Popular People' },
  { name: 'twitter:description', content: 'Discover the most popular celebrities on YouFlix.' },
  { name: 'twitter:image', content: 'https://youflix.xyz/api/ogimage?it=people' },
]);
